				...
				<div class="user-details">
					<div class="input-box">
						<span class="details">Full Name</span> <input type="text"
							name="username" placeholder="Enter your name" value="${username}" data-validate="enter user name"/>
							<form:errors path="username" cssClass="error"></form:errors>
					</div>
					<div class="input-box">
						<span class="details">Aadhar Number</span> <input type="text"
							name="aadharNumber" placeholder="Enter your aadhar" value="${aadharNumber}"/>
					...
					<div class="input-box">
						<span class="details">Password</span> <input type="password"
							name="password" placeholder="Enter your password" value="${password}"/>
							<form:errors path="password" cssClass="error"></form:errors>
					</div>
				</div>
				<p style="text-align: center;font-size: 12px;">	<span style="color: red;font-style: italic;font-weight: bold;">${message}</span></p>
				
				<div class="button">
					<input type="submit" value="Register" />
					<br>
					<br>
					<p style="text-align: center">Already have an account <a href="/signin">Login</a></p>
				</div>
			</form:form>
