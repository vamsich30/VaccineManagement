...
<title>Edit Covishield Page</title>
<!-- plugins:css -->
				...
				<div class="content-wrapper">
					<div class="row">
						<div class="col-12 grid-margin stretch-card">
							<div class="card">
								<div class="card-body">
									<h4 class="card-title">Edit CoviShield Centers</h4>
									<p class="card-description"></p>
									<form class="forms-sample" action="/admin/centers/edit/covishield"
										method="post">
										...
										<span style="color: green;font-size: 24px;font-style: italic;">${msg}</span>
									</form>
								</div>
							</div>
						</div>
