...
<body>
	...
	<strong>	Select your vaccine name </strong>&emsp;&emsp;&emsp;&emsp;
		...
		<strong>	Select First Dose Date</strong>&emsp;&emsp;&emsp;&emsp;
	...
	<strong><span style="color: red;font-size: 26;font-weight: bold;">${errormessage}</span></strong>
	<strong><span style="color: green;font-size: 26;font-weight: bold;">${msg}</span></strong>
</body>
</html>